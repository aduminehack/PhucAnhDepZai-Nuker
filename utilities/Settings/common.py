...
def proxy_scrape(): 
    startTime = time.time()
    temp = getTempDir()+"\\PhucAnhDepZai_proxies"                               
...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}PhucAnhDepZai-Nuker FREE    |    Made by aduminehack    |    Tokens: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}PhucAnhDepZai-Nuker FREE    |    Made by aduminehack    |    Tokens: [{counttokens}]")
    else:
        pass
...
PhucAnhDepZai = r'''
 ...
 /____|  \___| |_| |_| |_|  \__| |___/  \__,_|   /_/   \_\  \__|  \__|  \__,_|  \___| |_|\_\
        ...
        Github.com/aduminehack
'''
System.Size(120, 30)
System.Clear()
Anime.Fade(Center.Center(PhucAnhDepZai), Colors.purple_to_blue, Colorate.Vertical, interval=0.030, enter=True)
